                        ...
                        content: [
                            {
                                ...
                                content: [
                                    {
                                        type: "img",
                                        src: path.join(root_paths.src_path, "assets", env.client.logo.png),
                                        style: {
                                            max_height: "0.5cm",
                                            display: "flex",
        ...
        returned_object.footer = [
            {
                ...
                left: [
                    ...
                    {
                        type: "img",
                        src: path.join(root_paths.app_path, "server/assets/images", env.corp.logo.svg),
                        style: {
                            margin_left: "4px",
                            margin_top: "-1px",
                            display: "block",
